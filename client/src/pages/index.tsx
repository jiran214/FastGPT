...
const RegisterForm = dynamic(() => import('./login/components/RegisterForm'));
const ForgetPasswordForm = dynamic(() => import('./login/components/ForgetPasswordForm'));
